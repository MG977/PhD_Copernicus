...
Introduction to Copernicus Services
====================================
...
For hands-on, look at the following recommended practices by the `United Nations Office for Outer Space Affairs <https://un-spider.org/>`_ using QGIS and open data:
